...
//	private static String week[] = {"周日","周一","周二","周三","周四","周五","周六"};
	...
	private ArrayList<String> dayNumbers=new ArrayList<String>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String d = dayNumbers.get(position).split("\\.")[0];
...
//		}
		...
		if (position < daysOfMonth + dayOfWeek && position >= dayOfWeek) {
			...
			drawable = res.getDrawable(R.drawable.clickselector);
			if(showYear.equals(sel_year)&&showMonth.equals(sel_month)&&selectionPosition==position){
				drawable = res.getDrawable(R.drawable.button_pressed);
		...
		if(currentFlag == position){ 
			//设置当天的背景
			textView.setBackgroundResource(R.drawable.button_unpressed);
			textView.setTextColor(Color.BLACK);
		}
		return convertView;
	}
...
//			}
	...
	public void setSelect(String year,String month,int position){
		sel_year=year;
		sel_month=month;
